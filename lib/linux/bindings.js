...
blenoBindings.init = function() {
  ...
  this._hciBle.on('addressChange', this.onAddressChange.bind(this));
  ...
  this._l2capBle.on('mtuChange', this.onMTUUpdate.bind(this));
};
...
blenoBindings.onMTUUpdate = function(mtu) {
